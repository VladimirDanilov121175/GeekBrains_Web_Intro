...
$skills = [
	['skill' => 'Adobe Photoshop', 'value' => 30],
  	['skill' => 'Photography', 'value' => 70],
	['skill' => 'Illustrator', 'value' => 10],
	['skill' => 'Media', 'value' => 40]
];
...
$experience = [
	['job' => 'Front End Developer', 'start' => 'Jan 2015', 'end' => 'Current'],
    ['job' => 'Web Developer / something.com', 'start' => 'Mar 2012', 'end' => 'Dec 2014'],
    ['job' => 'Graphic Designer / designsomething.com', 'start' => 'Jun 2010', 'end' => 'Mar 2012']
];
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php foreach ($experience as $key => $item):?>
          
          
        <div class="w3-container">
           
          <h5 class="w3-opacity"><b><?=$item['job']?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$item['start']?> - 
